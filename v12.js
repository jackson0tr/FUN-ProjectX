class QuestionManager {
  ...
  class App {
    ...
    generateModelLink() {
      ...
      // Encrypt each answer using base64 encoding
      this.questionManager.answers.forEach((answer) => {
        const encryptedAnswer = btoa(answer.answer); // Base64 encoding
        const encryptedQuestionIndex= btoa(answer.questionIndex); // Base64 encoding
